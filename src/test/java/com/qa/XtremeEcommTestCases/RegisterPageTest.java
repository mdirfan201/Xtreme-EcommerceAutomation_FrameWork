...
public class RegisterPageTest extends TestBase{
	...
	public void setupExtentReport() {
		...
		spark= new ExtentSparkReporter("C:\\Users\\mohammed\\eclipse-workspace\\Xtreme-EcommerceAutomation_FrameWork\\Extent-Report\\XtremeEcommerce-RegisterPage.html");
	...
	public void setup() {
		...
		homepage.headerRegisterBtn.click();
	...
	public void verifyHomePageLogoTest() {
		...
		boolean flag=registerpage.verifyLogo(); 
	...
	public void validateEmptyData() throws InterruptedException {
		...
		registerpage.setEmptyRegister();
		test.info("The warning message-->" +registerpage.Warning.getText());
	}
	@Test(priority = 3)
	public void validateContinueViaGoogle() throws InterruptedException {
		...
		registerpage.validateContinueViaGoogle();
	}
	@DataProvider
	...
	public void validatesetRegisterData(String Email, String Password, String RetypePassword) {
		test=extent.createTest("TC_04 :HOME-PAGE  validate Register Data Test");
		try {
			registerpage.setRegister(Email, Password, RetypePassword);
